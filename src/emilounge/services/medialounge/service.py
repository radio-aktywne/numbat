...
from emilounge.config.models import MedialoungeConfig
from emilounge.services.medialounge import errors as e
from emilounge.services.medialounge import models as m
from emilounge.utils import asyncify, syncify
from emilounge.utils.read import ReadableIterator
from emilounge.utils.time import httpparse
...
class MedialoungeService:
    """Service for medialounge database."""

    def __init__(self, config: MedialoungeConfig) -> None:
        self._client = Minio(
