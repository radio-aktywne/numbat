...
```sh
curl --request GET --output prerecording.opus http://localhost:10600/prerecordings/0f339cb0-7ab4-43fe-852d-75708232f76c/2024-01-01T00:00:00
```
